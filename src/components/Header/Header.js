...
export default class Header extends Component {
  render() {
    return (
      <Container fluid={true} className="py-3 bg-white d-flex px-3 px-md-5 justify-content-center align-content-center bb-2-fog">
        <NavLink to="/" className="d-flex mr-auto">
          <img src={logo} alt="" className="d-flex align-self-center" style={{maxWidth: '150px'}} />
        </NavLink>
        <div className="nav d-flex align-self-center ml-auto">
